    ...
    <section id='about'>
      ...
      <div className='about_content'>
        ...
        <p className='statement'>
          ...
          Our mission is to provide these services to help guide therapists in reaching their goal.
        </p>
      </div>
      <div className='about_content'>
        <h1>Why Us</h1>  
        <p className='statement'>
          We not only provide services for kids but also for certified therapists. 
          There is a need for new therapist to be exposed to certain scenarios. 
          Our collection of scenarios help solve that need and allow for a better understanding of what to do in a specific situation.
        </p>
      </div>
    </section>
  )
